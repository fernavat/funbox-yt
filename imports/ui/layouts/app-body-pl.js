...
//import { insert } from '../../api/playlists/methods.js';
...
*/
/*
Template.App_body_2.events({
  'click'(){
    console.log(JSON.stringify(Playlists.find().fetch()))
    console.log(JSON.stringify(Lists.find().fetch()))
  }
})
*/
/*
